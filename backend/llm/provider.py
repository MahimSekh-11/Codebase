...
class LLMProvider:
        ...
        if self.provider == "gemini":
            ...
            if not api_key:
                ...
                try:
                    ...
                    # Use gemini-3.1-flash - fast, capable, free-tier available
                    self._model = settings.llm_model or "gemini-3.1-flash"
    ...
    def generate(self, prompt: str, api_key: str = None) -> str:
        if self.provider == "gemini":
            ...
            client = self._client
            model_name = getattr(self, "_model", "gemini-3.1-flash")
